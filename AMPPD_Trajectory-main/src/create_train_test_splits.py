...
class Splits:
    ...
    def _subset_data(self, age_threshold: float = 65.0):
        ...
        # for AMP-PD, removing donor PM-MS_55245
        # can add other restrictions here if desired
        self.cell_idx = np.where(np.array(self.meta["obs"]["SubID"]) != "PM-MS_55245")[0]
    ...
    def _split_by_subjects(self):
        ...
        subjects = np.unique(np.array(self.meta["obs"]["SubID"])[self.cell_idx])
...
if __name__ == "__main__":
    ...
    metadata_fn = "/home/masse/work/data/psychAD_PD/metadata.pkl"
    save_fn = "/home/masse/work/data/psychAD_PD/train_test_20splits.pkl"

    splits = Splits(metadata_fn, save_fn, n_splits=20, seed=42)
